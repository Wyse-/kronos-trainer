			...
			if (ServerPacket.field2109 == var1.serverPacket) {
				...
				if (ServerPacket.field2144 == var1.serverPacket) {
					...
					for (var8 = 0; var8 < var7; ++var8) {
						...
						var10 = var3.readByteA();
						if (var10 == 255) {
							var10 = var3.readLEInt();
						}
				...
				if (ServerPacket.field2104 == var1.serverPacket) {
					GrandExchangeOfferTotalQuantityComparator.method105(class185.removeGroundItem);
					var1.serverPacket = null;
					return true;
				}
